    ...
    <div className="space-y-6 pb-20">
      ...
      <div className="rounded-3xl p-7" style={{ background: 'linear-gradient(160deg, #1C1B18, #121110)' }}>
        <div className="flex items-center gap-2.5 mb-5">
          <span className="w-9 h-9 rounded-xl bg-[#FF5500] flex items-center justify-center">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {[
          ...
          <div key={c.title} className="bg-[var(--app-surface)] rounded-3xl border border-[color:var(--app-border)] p-5 flex flex-col">
            <div className="w-10 h-10 rounded-xl bg-[var(--app-accent-soft)] flex items-center justify-center text-[#FF5500] mb-3">
              {c.icon}
            </div>
            ...
            <Link href={c.href} className="mt-4 inline-flex items-center gap-1 text-[12px] font-bold text-[#FF5500] hover:underline">
      ...
      <div className="bg-[var(--app-surface-2)] rounded-3xl px-5 py-4 flex items-center justify-between gap-4">
        ...
        <Link href="/settings"
          className="shrink-0 inline-flex items-center gap-1.5 h-9 px-4 rounded-full bg-[var(--app-surface)] border border-[color:var(--app-border)] text-[12px] font-bold text-[color:var(--app-text)] hover:border-[#FF5500] hover:text-[#FF5500] transition-colors">

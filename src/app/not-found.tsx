  ...
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center p-6 text-center bg-[var(--app-bg)]">
      ...
      <div className="flex flex-wrap items-center justify-center gap-4">
        <Link
          href="/dashboard"
          className="px-6 py-3 bg-[#FF5C00] hover:bg-[#E04B00] text-white font-extrabold text-xs uppercase tracking-wider rounded-xl shadow-lg shadow-[#FF5C00]/25 transition-all flex items-center gap-2"
        >
          <Home className="w-4 h-4" /> Tableau de bord
        </Link>
        <Link
          href="/"
          className="px-6 py-3 bg-[var(--app-surface-2)] border border-[color:var(--app-border)] hover:border-[#FF5C00] text-[color:var(--app-text)] font-extrabold text-xs uppercase tracking-wider rounded-xl transition-all flex items-center gap-2"
        >
